package mvc.view {
	 ...
	 */
	public class ModuleNameMediator extends Mediator {
		// Cannonical name of the Mediator
		public static const NAME : String = "ModuleNameMediator";

		public function ModuleNameMediator(viewComponent : ModuleName) {
		...
		public function get moduleName() : ModuleName {
			return viewComponent as ModuleName;
		}
	}
}