...
package com.raytoon.cannonfodder.puremvc.view.ui.optionMainLayer.element.bullet
{
	 ...
	 */
	public class BulletLineOne extends Element
	{
		...
		public function BulletLineOne(from:Element, path:int = 1, pngName:String = "LineBullet") {
			super();
			row = from.row;
			num = from.num;
			_shooter = from;
			...
			if (_obElement) {
				...
				_bulletMovie.height = position.y;
			}
