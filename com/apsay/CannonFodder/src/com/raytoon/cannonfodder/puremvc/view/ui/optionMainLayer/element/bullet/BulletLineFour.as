...
package com.raytoon.cannonfodder.puremvc.view.ui.optionMainLayer.element.bullet
{
	 ...
	 */
	public class BulletLineFour extends Element
	{
		...
		public function BulletLineFour(from:Element, path:int = 4, pngName:String = "LineBullet") {
			super();
			row = from.row;
			num = from.num;
			_shooter = from;
